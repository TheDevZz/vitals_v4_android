...
LIVE_METHOD(nativeDetectYuv)(JNIEnv *env, jobject instance, jbyteArray yuv, jint preview_width,
                             jint preview_height, jint orientation, jint left, jint top, jint right,
                             jint bottom);

JNIEXPORT jfloat JNICALL
LIVE_METHOD(nativeDetectBitmap)(JNIEnv *env, jobject instance, jobject bitmap, jint left, jint top,
